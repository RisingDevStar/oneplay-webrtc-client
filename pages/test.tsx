...
export default function Home () {
  ...
  const addHIDhandler = (element: HTMLVideoElement) => {
    // Mouse event
    element.addEventListener(MOUSE_CLICK, mouseEventHandler(element, MOUSE_CLICK))
    element.addEventListener(MOUSE_DOUBLECLICK, mouseEventHandler(element, MOUSE_DOUBLECLICK))
    element.addEventListener(MOUSE_UP, mouseEventHandler(element, MOUSE_UP))
    element.addEventListener(MOUSE_DOWN, mouseEventHandler(element, MOUSE_DOWN))
    element.addEventListener(MOUSE_MOVE, mouseEventHandler(element, MOUSE_MOVE))
    // Mouse wheel event
    element.addEventListener(MOUSE_WHELL, wheelEventHandler(element, MOUSE_WHELL))
    // Keyboard event
    document.addEventListener(KEY_PRESS, keyBoardEventHandler(element, KEY_PRESS))
    document.addEventListener(KEY_DOWN, keyBoardEventHandler(element, KEY_DOWN))
    document.addEventListener(KEY_UP, keyBoardEventHandler(element, KEY_UP))
    // Gamepad event
  ...
  const removeHIDhandler = (element: HTMLVideoElement) => {
    // Mouse event
    element.removeEventListener(MOUSE_CLICK, mouseEventHandler(element, MOUSE_CLICK))
    element.removeEventListener(MOUSE_DOUBLECLICK, mouseEventHandler(element, MOUSE_DOUBLECLICK))
    element.removeEventListener(MOUSE_UP, mouseEventHandler(element, MOUSE_UP))
    element.removeEventListener(MOUSE_DOWN, mouseEventHandler(element, MOUSE_DOWN))
    element.removeEventListener(MOUSE_MOVE, mouseEventHandler(element, MOUSE_MOVE))
    // Mouse wheel event
    element.removeEventListener(MOUSE_WHELL, wheelEventHandler(element, MOUSE_WHELL))
    // Keyboard event
    document.removeEventListener(KEY_PRESS, keyBoardEventHandler(element, KEY_PRESS))
    document.removeEventListener(KEY_DOWN, keyBoardEventHandler(element, KEY_DOWN))
    document.removeEventListener(KEY_UP, keyBoardEventHandler(element, KEY_UP))
  }
